                ...
                <div>
                  <div className="flex justify-between mb-1">
                    ...
                    <span className="text-xs font-semibold text-orange-600">
                      {((tax.otherIncomeKRW ?? 0) / 10000).toLocaleString()}만원/년
                    </span>
                  </div>
                  <input
                    type="range" min={0} max={300_000_000} step={1_000_000}
                    value={tax.otherIncomeKRW ?? 0}
                  ...
                  <p className="text-xs text-slate-400 mt-1">
                    초과 금융소득과 합산해 누진세 구간을 자동으로 결정합니다
                  </p>
                </div>
