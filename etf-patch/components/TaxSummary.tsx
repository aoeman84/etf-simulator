...
export default function TaxSummary({ result, taxEnabled }: Props) {
  ...
  const otherIncome = 0 // TaxSummary는 표시 전용 — 다른소득은 TaxPanel에서 설정
  const combinedIncome = t.financialIncomeKRW + otherIncome
  const bracketLabel = getTaxBracketLabel(
    t.exceedsThreshold ? combinedIncome - 20_000_000 : 0
  )
  ...
  return (
    <div className="card p-5 space-y-4">
      ...
      <div className="space-y-2">
        ...
        <TaxRow
          label="미국 원천징수 15%"
          value={`-${fmtKRW(t.withholdingTaxKRW)}`}
          negative
        />
        {t.surchargeKRW > 0 && (
          <TaxRow
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <div className="text-xs text-orange-600 mt-0.5">
                ...
                초과분 {fmtKRW(t.financialIncomeKRW - 20_000_000)}에{' '}
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <div className="text-xs text-green-600 mt-0.5">
                연 금융소득 {fmtKRW(t.financialIncomeKRW)} — 2,000만원 이하<br />
      ...
      <div className="space-y-2">
        ...
        <TaxRow
          label="250만원 기본공제 후 양도세 22%"
          value={`-${fmtKRW(t.capitalGainsTaxKRW)}`}
          negative
        />
        <div className="border-t border-slate-100 pt-2">
...
function TaxRow({
  ...
  return (
    <div className="flex justify-between items-center">
      <span
        className={`text-xs ${
          highlight ? 'font-semibold text-slate-700' : 'text-slate-500'
        }`}
      >
        {label}
      </span>
